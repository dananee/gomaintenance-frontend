            ...
            {templates.map((tpl) => (
              ...
              >
                ...
                <div className="grid gap-3 md:grid-cols-2 md:gap-6">
                  ...
                  <div className="space-y-2 text-sm text-gm-muted">
                    <p className="text-xs uppercase tracking-wide text-gm-muted">Parts</p>
                    <div className="flex flex-wrap gap-2">
                      {tpl.parts.map((part) => (
                        <Badge
                          key={part}
          ...
          <Tabs defaultValue="details">
            ...
            <TabsContent value="details" className="space-y-3 pt-4">
              ...
              <Input
                ...
                onChange={(e) => setDraft((d) => ({ ...d, vehicles: e.target.value }))}
                className="border-gm-border bg-gm-panel text-foreground"
              />
            </TabsContent>
            ...
            <TabsContent value="operations" className="space-y-3 pt-4">
              <Input
                ...
                onChange={(e) => setDraft((d) => ({ ...d, operations: e.target.value }))}
                className="border-gm-border bg-gm-panel text-foreground"
              />
              <Input
                placeholder="Parts (comma separated)"
                value={draft.parts}
                onChange={(e) => setDraft((d) => ({ ...d, parts: e.target.value }))}
                className="border-gm-border bg-gm-panel text-foreground"
              />
            </TabsContent>
          </Tabs>
