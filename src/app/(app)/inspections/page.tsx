...
const upcoming = [
  { id: 1, vehicle: "Ford Transit", date: "2024-07-05", location: "Depot A", status: "scheduled" },
  { id: 2, vehicle: "Volvo FH16", date: "2024-07-07", location: "On-site", status: "scheduled" },
];

const expired = [
  { id: 3, vehicle: "Iveco Daily", date: "2024-06-21", location: "Depot B", status: "overdue" },
];
